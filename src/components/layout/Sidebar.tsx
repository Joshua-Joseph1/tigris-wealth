...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="h-32 flex items-center justify-center px-6 border-b border-border relative">
          <Image
            src="/images/logo.png"
            alt="Logo"
            width={96}
          ...
          <button
            onClick={closeMobileSidebar}
            className="lg:hidden p-2 hover:bg-surface rounded-lg transition-colors absolute top-4 right-4"
            style={{ zIndex: 1 }}
          >
            <X className="h-5 w-5" />
          </button>
